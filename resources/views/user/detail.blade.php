                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="images/p1.jpg">
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <h3>Rp 270.000 <span>700.000</span></h3>
                            ...
                            <div class="product__details__cart__option">
                                ...
                                <a href="{{ route('checkout') }}" class="primary-btn rounded-full bg-toychest1 hover:bg-toychest2 hover:text-white transition ease-in-out duration-300">Buy</a>
                            </div>
                            ...
                            <div class="product__details__last__option">
                                ...
                                <ul>
                                    <li><span>SKU:</span> 381291</li>
                                    <li><span>Categories:</span> Toddler Toys</li>
